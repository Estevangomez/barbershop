...
async function seedDatabase() {
  try {
    ...
    const services = [
      ...
      {
        nome: "Barboterapia",
        descricao: "Cuidado especial com a barba hidratação.",
        preco: 40.0,
        imageurl: "https://utfs.io/f/0ddfbd26-a424-43a0-aaf3-c3f1dc6be6d1-1kgxo7.png",
      },
      {
...
for (const service of services) {
  await prisma.servico.create({
    data: {
      ...
      preco: service.preco,
      barbeariaId: barbearia.id,  // Use the foreign key field directly
      imageUrl: service.imageurl,
    },
  });
}

      barbershops.push(barbearia);
    }
